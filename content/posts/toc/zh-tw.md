---
title: 給長文章加目錄
description: 使用真正的 Markdown 標題，讓主題產生可用的文章目錄。
date: 2026-09-08
---

# 給長文章加目錄

文章目錄從真正的 Markdown 標題產生。讀者可以直接跳到章節，不需要你複製錨點。
...
目前文章樣式可以在正文旁顯示目錄。如果目前主題匯出了 `toc` Block，需要指定目錄位置時，可在正文加入：
...
目錄連結會指向產生的章節 ID。點選連結會跳到章節；目錄收起或窄螢幕時，文章仍然可以閱讀。
