...
这是一篇 3.0 版本线的历史更新说明。当前站点写法请以[4.0.0](/zh-sg/updates/4.0.0/)和[配置结构](/zh-sg/posts/site-settings/)为准；新站不应从旧版本文章复制配置。

## 3.0.2 发布了什么

- 版本说明通过 post pipeline 和 `content/updates/ collection` 生成。筛选后的 `updates` collection 把版本说明与普通 post 分开，同时保留多语言归档、详情、Feed、搜索和语言链接。
...
4.0.0 是当前 breaking architecture release。复制旧 checkout 的配置前，请先阅读[4.0.0 更新说明](/zh-sg/updates/4.0.0/)。
