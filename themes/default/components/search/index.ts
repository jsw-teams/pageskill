...
export const component: ComponentDefinition = {
  ...
  resources: { styles: ['components/search/style.css'] },
  client: { module: 'components/search/script.js', selector: '[data-local-search]' },
