...
export const component: ComponentDefinition = {
  ...
  resources: { styles: ['components/comments/style.css'], scripts: ['components/comments/script.js'] },
